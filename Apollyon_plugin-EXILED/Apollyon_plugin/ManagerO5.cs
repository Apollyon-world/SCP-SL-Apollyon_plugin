...
{
    public class ManagerO5 : Plugin<Config>
    {
        public static ManagerO5 Singleton;

        public override string Name => "Apollyon_plugin";
        public override string Author => "Apollyon_world";
        ...
        public override void OnEnabled()
        {
            ...
            harmony = new Harmony($"Apollyon_world Manager O5-{DateTime.Now.Ticks}");
            harmony.PatchAll();
